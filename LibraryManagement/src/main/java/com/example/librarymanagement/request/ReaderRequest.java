...
public class ReaderRequest {
    ...
    public ReaderRequest(String fullName, String email, String phoneNumber, String address, LocalDate dob, String gender, String citizenshipCard, String readerCode) {
